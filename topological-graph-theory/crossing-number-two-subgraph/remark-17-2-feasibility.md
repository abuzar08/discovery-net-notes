...
giving 9,295,757 expansions for `d ≤ 4`, 209,699,814 for `d ≤ 5`, and
4,647,218,219 for `d ≤ 6`.

## The binding constraint is not core-hours

An earlier estimate put `d ≤ 6` at ≈ 47 core-hours. **That figure was wrong**,
...
Not one sampled `d = 6` expansion is decidable by the tool. So `d ≤ 6` is not an
...
is unchanged by subdividing an edge, on C₃□C₃, K₅, K₃,₃ and K₆.

## What is being run

`expand_run.py run 4` — every expansion of all 17 seeds with `d ≤ 4`, resumable,
